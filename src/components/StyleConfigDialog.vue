  ...
  >
    <el-tabs v-model="activeTab">
      ...
      <el-tab-pane label="全局样式" name="global">
        <el-form :model="globalStyle" label-width="120px">
          <el-row :gutter="20">
            <el-col :span="12">
          ...
          <el-row :gutter="20">
            <el-col :span="12">
              <el-form-item label="数据行背景色">
                <el-color-picker v-model="globalStyle.rowBgColor" show-alpha />
              </el-form-item>
            </el-col>
            <el-col :span="12">
      ...
      <el-tab-pane label="单元格/行/列样式" name="cell">
        ...
        <div v-if="selectedCell" class="cell-style-form">
          <el-divider content-position="left">
            当前选中: 第 {{ selectedCell.row + 1 }} 行,第
            {{ selectedCell.col + 1 }} 列
          </el-divider>

          <!-- 应用范围选择 -->
          <el-form-item label="应用范围" label-width="100px">
            <el-radio-group v-model="applyScope" size="large">
              <el-radio-button label="cell">当前单元格</el-radio-button>
              <el-radio-button label="row">整行</el-radio-button>
              <el-radio-button label="column">整列(不含表头)</el-radio-button>
            </el-radio-group>
          </el-form-item>
          ...
          <el-form :model="cellStyle" label-width="100px">
            <el-row :gutter="20">
              ...
              <el-col :span="12">
                <el-form-item label="文字颜色">
                  <el-color-picker v-model="cellStyle.color" show-alpha />
                </el-form-item>
              </el-col>
            </el-row>
            ...
            <el-form-item>
              <el-button type="primary" size="small" @click="applyCellStyle">
                <el-icon><Check /></el-icon>
                应用样式
              </el-button>
              <el-button size="small" @click="clearCellStyle">
